    ...
    return (
      <div className="edit-form">
        <div className="mb-4">
          ...
          <input type="text" id="title" name="title" value={editedTask.title} onChange={handleInputChange}
        ...
        <div className="mb-4">
          <label htmlFor="mission" className="text-sm font-medium text-gray-700">Mission:</label>
          <select id="mission" name="mission" value={editedTask.mission} onChange={handleInputChange}
            className="border border-gray-300 rounded-md px-2 py-1 mt-1 w-full">
        ...
        <div className="mb-4">
          ...
          <DatePicker id="deadline" name="deadline" selected={editedTask.deadline} onChange={handleDateChange}
            className="border border-gray-300 rounded-md px-2 py-1 mt-1 w-full" />
        </div>
        <div className="flex justify-end">
          <button onClick={handleSave} className="bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md">
            Save
          </button>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="flex items-center mt-4">
              <div className="mr-2 flex items-center">
                <FaEdit onClick={() => setIsEditing(true)} className="text-gray-600 cursor-pointer" />
              </div>
  ...
  return (
    <div className="drag-and-drop-container">
      <div className="card p-4 bg-red-100" onDragOver={handleDragOver} onDrop={event => handleDrop(event, 'todo')}>
        ...
        <button onClick={handleAddTask} className="bg-red-500 hover:bg-red-600 text-white font-medium py-2 px-4 rounded-md mt-4">
          Add Task
        </button>
      </div>
      <div className="card p-4 bg-blue-100" onDragOver={handleDragOver} onDrop={event => handleDrop(event, 'inProgress')}>
      ...
      <div className="card p-4 bg-green-100" onDragOver={handleDragOver} onDrop={event => handleDrop(event, 'completed')}>
